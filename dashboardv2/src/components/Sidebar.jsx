...
const navGroups = [
  ...
  },
  {
    title: 'Charging',
    items: [
      { name: 'Charging Stations', icon: MapPin, path: '/charging-stations' },
      { name: 'Charge Points', icon: Zap, path: '/charge-points' },
                ...
                return (
                  <li key={itemIdx}>
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `relative w-[calc(100%+2rem)] flex items-center justify-between py-2.5 pr-7 pl-7 rounded-none -ml-4 text-sm font-medium transition-colors duration-200 cursor-pointer active:scale-[0.98] group border-l-2 overflow-hidden ${isActive
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          ...
                          {item.count && (
                            <span
                              className={`relative z-10 text-xs py-0.5 px-2 rounded-full transition-colors ${isActive
