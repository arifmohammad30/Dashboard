...
export default function ChargePointStatsTab({ cp }) {
  ...
  // Time range multiplier for dynamic data scaling
  ...
  // Hourly time labels for 24-hour axis
  const timeLabels = ['00:00', '02:00', '04:00', '06:00', '08:00', '10:00', '12:00', '14:00', '16:00', '18:00', '20:00', '22:00'];

  // Base raw data points matching reference Pulse console graphs
  ...
  // Chart Geometry Generator with Y-Axis scale & smooth spline curve
  ...
  return (
    <div className="flex flex-col gap-6 w-full animate-in fade-in duration-200">
      {/* Top Control Toolbar Bar - Higher z-index so dropdown floats over cards */}
      ...
      {/* Top 4 Minimal Tinted Metric Cards with Micro-Interactivity */}
      ...
      {/* Row 2: Revenue (₹) & Energy Delivered (kWh) Charts Side-by-Side */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
        ...
        {/* Energy Delivered (kWh) Chart Card */}
        <div className="bg-white border border-stone-200/90 rounded-2xl p-5 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between border-b border-stone-100 pb-3 mb-2">
            <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider flex items-center gap-2">
      ...
      {/* Row 3: Charging Sessions Full Width Chart Card */}
