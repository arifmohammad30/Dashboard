...
/**
 * Normal (Baseline) Pricing Section Component
 * Configures the default fallback rate (₹/kWh energy price, ₹/min time price, and baseline SOC tiers)
 * applied whenever no special Peak or Off-Peak window is active.
 */
